...
function getUserTranscriptionSettings(userId: string, conversationManager: ConversationManager): TranscriptionSettings {
    // Default settings
...
function updateUserTranscriptionSettings(
    userId: string,
...
function createTranscriptionSettingsKeyboard(settings: TranscriptionSettings, botId?: number): Markup.Markup<InlineKeyboardMarkup> {
...
function formatTranscriptionSettingsMessage(settings: TranscriptionSettings): string {
